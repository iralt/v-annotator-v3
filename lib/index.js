...
}, nx = /* @__PURE__ */ bt(xx, [["__scopeId", "data-v-16b52f73"]]), ix = { class: "ma-3" }, rx = { class: "text-h5 text-indigo ml-5" }, lx = { class: "ma-3" }, sx = { class: "text-h5 text-indigo ml-5" }, ax = { class: "d-flex justify-space-around my-3" }, ex = { class: "ma-3" }, ux = { class: "text-h5 text-indigo ml-5" }, Cx = /* @__PURE__ */ gt({
...
}), Gt = /* @__PURE__ */ bt(Cx, [["__scopeId", "data-v-60633842"]]);
function Bx(r) {
