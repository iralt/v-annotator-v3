...
import { defineComponent as mt, computed as k, createElementBlock as X, openBlock as W, withModifiers as x0, createElementVNode as y, toDisplayString as d, createBlock as nt, createCommentVNode as Pt, Fragment as at, renderList as ft, ref as T, watch as tt, nextTick as xt, onMounted as Nt, createVNode as h, resolveComponent as Z, withCtx as g, createTextVNode as I, normalizeStyle as kt, unref as N } from "vue";
...
function L0(r, n, x) {
  var i, l, s, a, e, A, C = 0, f = !1, v = !1, w = !0;
  if (typeof r != "function")
    throw new TypeError(w0);
  n = Mt(n) || 0, yt(x) && (f = !!x.leading, v = "maxWait" in x, s = v ? _0(Mt(x.maxWait) || 0, n) : s, w = "trailing" in x ? !!x.trailing : w);
  function O(p) {
    var j = i, Q = l;
  ...
  function D(p) {
    var j = p - A, Q = p - C, it = n - j;
    return v ? O0(it, s - Q) : it;
  }
  function b(p) {
    var j = p - A, Q = p - C;
    return A === void 0 || j >= n || j < 0 || v && Q >= s;
  }
  function P() {
    var p = vt();
    if (b(p))
  ...
  function Y() {
    e !== void 0 && clearTimeout(e), C = 0, i = A = l = e = void 0;
  }
  function m() {
    return e === void 0 ? a : J(vt());
  }
  function R() {
    var p = vt(), j = b(p);
    if (i = arguments, l = this, A = p, j) {
      if (e === void 0)
        return u(A);
      if (v)
        return clearTimeout(e), e = setTimeout(P, n), O(A);
    }
...
function qt(r, n, x) {
  let i;
  {
    ...
    M0(pt, l, s), i = W0(s, pt.msecs, pt.seq, n, x);
  }
  return k0(i);
}
function M0(r, n, x) {
...
const R0 = ["r", "fill", "cx", "cy"], I0 = ["x", "y", "dx", "textContent"], T0 = /* @__PURE__ */ mt({
...
}), P0 = ["x1", "y1", "x2", "y2", "stroke", "stroke-width"], N0 = /* @__PURE__ */ mt({
...
class c {
  constructor(n = void 0, x = void 0, i = null, l = null, s = null, a = $) {
    if (this.left = i, this.right = l, this.parent = s, this.color = a, this.item = { key: n, value: x }, n && n instanceof Array && n.length === 2 && !Number.isNaN(n[0]) && !Number.isNaN(n[1])) {
      let [e, A] = n;
      e > A && ([e, A] = [A, e]), this.item.key = new j0(e, A);
    }
...
class V0 {
  ...
  render(n, x, i) {
    ...
    for (const s of x) {
      const a = this.createRanges(n, s), e = s.startsAfter(this.textLine.startOffset), A = i.getWidth(s.label), C = a.getIntervals(e, A);
...
const K = Object.freeze({
  ...
  setup(r, { emit: n }) {
    ...
    return (v, w) => (W(), X("g", {
      ...
      (W(!0), X(at, null, ft(C.value, ([O, u], D) => (W(), nt(N0, {
        key: D,
        x1: O,
        x2: u,
        y: A.value,
...
}, Z0 = /* @__PURE__ */ wt(Y0, [["__scopeId", "data-v-72684c03"]]);
class K0 {
  constructor(n, x, i, l) {
...
`);
    ...
    l.set(`
`, 0);
    const a = parseFloat(window.getComputedStyle(x).fontSize), e = window.getComputedStyle(x).fontFamily, A = window.getComputedStyle(x).fontWeight, C = x.getBoundingClientRect().height;
    return x.textContent = "", new Dt(a, e, A, C, l);
  }
}
class Vt {
  ...
  render(n, x) {
    ...
    for (const s of this.relations) {
      if (!s.isVisible(this.textLine.startOffset))
        continue;
      let a = this.left, e = this.right, A = "";
      ...
      if (w && O ? (a = this.left, e = this.right) : w ? x ? C ? a = C.center : f && (a = f.center) : C ? e = C.center : f && (e = f.center) : O ? x ? C ? e = C.center : f && (e = f.center) : C ? a = C.center : f && (a = f.center) : f && C && (a = Math.min(f.center, C.center), e = Math.max(f.center, C.center)), f && a === f.center ? A = "start" : f && e === f.center && (A = "end"), a > e && ([a, e] = [e, a]), x && ([w, O] = [O, w]), e - a < v.truncatedWidth) {
        const D = a + (e - a) / 2, b = v.truncatedWidth / 2;
        this.levelManager.update(s, [[D - b, D + b]]);
      } else
...
const c0 = ["direction", "id", "height"], tx = ["transform"], xx = {
  ...
  setup(r, { emit: n }) {
    ...
    const s = T("500px"), a = k(() => `translate(0, ${x.font.lineHeight})`), e = k(() => l.value ? new V0(x.textLine, x.rtl).render(l.value, x.entities, x.entityLabels) : []), A = k(() => new d0(x.relations, x.relationLabels, x.textLine, x.left, x.right).render(e.value, x.rtl));
    k(() => Math.max(...A.value.map((m) => m.level), 0));
    const C = k(() => {
      const m = Math.max(...A.value.map((R) => R.level));
    ...
    return (m, R) => (W(), X("svg", {
      ...
      y("g", { transform: a.value }, [
        ...
        (W(!0), X(at, null, ft(e.value, (p) => (W(), nt(G0, {
          key: p.entity.id,
          ranges: p.ranges,
          color: P(p.entity),
          label: J(p.entity),
...
}, nx = /* @__PURE__ */ wt(xx, [["__scopeId", "data-v-7b0dff92"]]), ix = { class: "ma-3" }, rx = { class: "text-h5 text-indigo ml-5" }, lx = { class: "ma-3" }, sx = { class: "text-h5 text-indigo ml-5" }, ax = { class: "d-flex justify-space-around my-3" }, ex = { class: "ma-3" }, ux = { class: "text-h5 text-indigo ml-5" }, Cx = /* @__PURE__ */ mt({
  ...
  setup(r) {
    return (n, x) => {
      const i = Z("v-card-title"), l = Z("v-btn"), s = Z("v-card-subtitle"), a = Z("v-card"), e = Z("v-radio"), A = Z("v-radio-group"), C = Z("v-card-text"), f = Z("v-spacer"), v = Z("v-card-actions"), w = Z("v-dialog"), O = Z("v-icon");
      return W(), X(at, null, [
        h(w, {
                ...
                h(C, null, {
                  default: g(() => [
                    ...
                    h(A, {
                      ...
                      default: g(() => [
                        (W(!0), X(at, null, ft(n.entityLabels, (u) => (W(), nt(e, {
                          key: u.id,
                          label: `${u.id}: ${u.text}`,
                          value: u.id,
...
}), Gt = /* @__PURE__ */ wt(Cx, [["__scopeId", "data-v-cc04ca7c"]]);
function Bx(r) {
...
(function(r) {
  function n() {
    var x = 0, i = 1, l = 2, s = 3, a = 4, e = 5, A = 6, C = 7, f = 8, v = 9, w = 10, O = 11, u = 12, D = 13, b = 14, P = 15, J = 16, Y = 17, m = 0, R = 1, p = 2, j = 3, Q = 4;
    function it(t, F) {
    ...
    function Ft(t, F, S) {
      ...
      return [D, Y].indexOf(E[o]) != -1 && E.slice(o + 1, -1).every(function(V) {
        return V == s;
    ...
    function Ct(t) {
      ...
      43360 <= t && t <= 43388 ? A : 4448 <= t && t <= 4519 || // Lo  [72] HANGUL JUNGSEONG FILLER..HANGUL JUNGSEONG O-YAE
      ...
      129489 <= t && t <= 129501 ? D : 127995 <= t && t <= 127999 ? b : t == 8205 ? P : t == 9792 || // So       FEMALE SIGN
      t == 9794 || // So       MALE SIGN
...
class Fx {
  ...
  getRange() {
    ...
    if (!n || n.rangeCount === 0)
      return [0, 0];
    const x = (A = n.anchorNode) == null ? void 0 : A.parentNode, i = (C = n.focusNode) == null ? void 0 : C.parentNode;
    if (!x || !i)
      return [0, 0];
...
function Ex(r, n) {
  ...
  return {
    ...
    candidateEntity: i,
    addEntityWithDialog: (u, D, b, P) => {
      console.log("addEntity", D, b, P), i.value = {
        id: qt(),
        startOffset: D,
        endOffset: b,
        label: 1,
        text: P.substring(D, b)
      }, x.openAddingDialog();
    },
    updateEntityWithDialog: (u, D) => {
      console.log("updateEntity", D);
      const b = r.value.find((P) => P.id == D);
      b && (i.value = {
        id: b.id,
    ...
    deleteEntityWithDialog: (u) => {
      ...
      const D = r.value.find((b) => b.id == u.id);
      D && (i.value = {
        id: D.id,
...
const px = ["id"], yx = {
  ...
  setup(r, { expose: n, emit: x }) {
    ...
    const s = x, a = qt(), e = T(null), A = T({}), C = T(-1), f = T(0), v = T(0), w = T(0), O = T(null), u = T(null), D = T(null), b = T([...i.entitiesData]), P = T(i.text), J = T(!1), {
      entities: Y,
      candidateEntity: m,
    ...
    tt(
      ...
      D.value = B, window.addEventListener("resize", _t), _t(), console.log("Received text in VAnnotator:", i.text), console.log("Virtual scroll items:", _.value);
    }), tt(
      () => i.text,
      () => {
        A.value = {}, xt(() => {
          D.value && (e.value = Dt.create(i.text, D.value)), console.log("Font:", e.value, "*****************");
        });
      },
      { immediate: !0 }
    );
    const _ = k(() => !rt.value || rt.value.length === 0 ? [] : rt.value.map((B, L) => {
      const G = `${B.startOffset}:${B.endOffset}`, H = A.value[G] || 64;
      return {
        id: G,
        textLine: B,
        size: H
      ...
      return console.log("Entity array to process:", B), i.graphemeMode ? gt.valueOf(B, o.value) : gt.valueOf(B);
    }), Bt = k(() => (Ot(), new J0(i.relations, M.value))), rt = k(() => {
      if (console.log("Computing textLines..."), console.log("Font:", e.value), !e.value)
        return console.warn("Font is null, attempting to initialize."), xt(() => {
          D.value && (e.value = Dt.create(i.text, D.value), console.log("Font initialized:", e.value));
        }), [];
      if (console.log("Entity Label List:", V.value), console.log("Max Width:", C.value), !e.value || !V.value || C.value === -1)
    ...
    return (B, L) => {
      ...
      return W(), X("div", {
        ...
        N(m) && (N(F) || N(S) || N(E)) ? (W(), nt(Gt, {
          ...
          onUpdateEntitySubtractSuffix: N(Ft),
