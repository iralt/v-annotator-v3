...
import { defineComponent as gt, computed as k, createElementBlock as X, openBlock as R, withModifiers as x0, createElementVNode as p, toDisplayString as Q, createBlock as xt, createCommentVNode as Pt, Fragment as rt, renderList as ft, ref as P, watch as tt, nextTick as lt, onMounted as Nt, createVNode as h, resolveComponent as Z, withCtx as A, createTextVNode as W, normalizeStyle as kt, unref as T } from "vue";
var n0 = typeof global == "object" && global && global.Object === Object && global, i0 = typeof self == "object" && self && self.Object === Object && self, jt = n0 || i0 || Function("return this")(), ht = jt.Symbol, Ut = Object.prototype, r0 = Ut.hasOwnProperty, l0 = Ut.toString, at = ht ? ht.toStringTag : void 0;
function s0(r) {
  var n = r0.call(r, at), x = r[at];
  try {
    r[at] = void 0;
    var i = !0;
  } catch {
  ...
  var l = l0.call(r);
  return i && (n ? r[at] = x : delete r[at]), l;
}
...
function L0(r, n, x) {
  ...
  function O(y) {
    var j = i, o = l;
    return i = l = void 0, C = y, a = r.apply(o, j), a;
  }
  function u(y) {
    return C = y, e = setTimeout(N, n), f ? O(y) : a;
  }
  function g(y) {
    var j = y - D, o = y - C, nt = n - j;
    return v ? O0(nt, s - o) : nt;
  }
  function b(y) {
    var j = y - D, o = y - C;
    return D === void 0 || j >= n || j < 0 || v && o >= s;
  }
  function N() {
    var y = Ft();
    if (b(y))
  ...
  function J(y) {
    return e = void 0, w && i ? O(y) : (i = l = void 0, a);
  }
  function Y() {
  ...
  function I() {
    var y = Ft(), j = b(y);
    if (i = arguments, l = this, D = y, j) {
      if (e === void 0)
        return u(D);
      if (v)
        return clearTimeout(e), e = setTimeout(N, n), O(D);
    }
    return e === void 0 && (e = setTimeout(N, n)), a;
  }
...
const K = Object.freeze({
  ...
  setup(r, { emit: n }) {
    ...
    return (v, w) => (R(), X("g", {
      ...
      (R(!0), X(rt, null, ft(C.value, ([O, u], g) => (R(), xt(N0, {
        key: g,
        x1: O,
        x2: u,
        y: D.value,
  ...
  setup(r) {
    const n = r, x = P(null), i = k(() => n.text.substring(
...
const c0 = ["direction", "id", "height"], tx = ["transform"], xx = {
  ...
  setup(r, { emit: n }) {
    ...
    const s = P("500px"), a = k(() => `translate(0, ${x.font.lineHeight})`), e = k(() => l.value ? new V0(x.textLine, x.rtl).render(l.value, x.entities, x.entityLabels) : []), D = k(() => new d0(x.relations, x.relationLabels, x.textLine, x.left, x.right).render(e.value, x.rtl));
    k(() => Math.max(...D.value.map((m) => m.level), 0));
    const C = k(() => {
      const m = Math.max(...D.value.map((I) => I.level));
    ...
    function g() {
      ...
      if (m) {
        const I = m.getBBox().height + 30;
        m.style.height = `${I}px`, i("update:height", v.value, I);
      }
    }
    function b(m) {
    ...
    function Y(m) {
      return x.selectedRelation ? x.selectedRelation.consistOf(m) : x.selectedEntities.some((I) => I.id === m.id);
    }
    return (m, I) => (R(), X("svg", {
      version: "1.1",
      ...
      p("g", { transform: a.value }, [
        ...
        (R(!0), X(rt, null, ft(e.value, (y) => (R(), xt(G0, {
          key: y.entity.id,
          ranges: y.ranges,
          color: N(y.entity),
          label: J(y.entity),
          ...
          selected: Y(y.entity),
          "onClick:entity": (j) => m.$emit("click:entity", j, y.entity),
          "onContextmenu:entity": (j) => m.$emit("contextmenu:entity", y.entity),
          onMouseover: (j) => m.$emit("setSelectedEntity", y.entity),
          onMouseleave: I[0] || (I[0] = (j) => m.$emit("setSelectedEntity", null))
                ...
                h(C, null, {
                  default: A(() => [
                    h(a, { variant: "outlined" }, {
                      default: A(() => [
                        p("div", ix, [
                          x[16] || (x[16] = p("span", null, [
                            p("small", null, "選択したテキスト:")
                          ], -1)),
                          p("span", rx, [
                            p("b", null, Q(n.candidateEntity.text), 1)
                          ])
                        ])
                      ]),
                      _: 1
                    ...
                    h(D, {
                      ...
                      default: A(() => [
                        (R(!0), X(rt, null, ft(n.entityLabels, (u) => (R(), xt(e, {
                          key: u.id,
                          label: `${u.id}: ${u.text}`,
                          value: u.id,
          ...
          default: A(() => [
            h(a, {
              ...
              default: A(() => [
                ...
                h(s, null, {
                  default: A(() => [
                    x[21] || (x[21] = W(" 修正する場合は、範囲指定をし直すか、ラベルを選んで、")),
                    h(l, {
                      color: "green",
                      variant: "tonal",
                      size: "small"
                  ...
                  default: A(() => [
                    h(a, { variant: "outlined" }, {
                      default: A(() => [
                        ...
                        x[30] || (x[30] = p("hr", { class: "mx-10" }, null, -1)),
                        p("div", ax, [
                          h(f),
                          p("div", null, [
                            h(l, {
                          ...
                          x[28] || (x[28] = p("div", { class: "mx-2 mt-1" }, "前", -1)),
                          p("div", null, [
                            h(l, {
                          ...
                          x[29] || (x[29] = p("div", { class: "mx-2 mt-1" }, "後", -1)),
                          p("div", null, [
                            h(l, {
...
(function(r) {
  function n() {
    var x = 0, i = 1, l = 2, s = 3, a = 4, e = 5, D = 6, C = 7, f = 8, v = 9, w = 10, O = 11, u = 12, g = 13, b = 14, N = 15, J = 16, Y = 17, m = 0, I = 1, y = 2, j = 3, o = 4;
    function nt(t, F) {
    ...
    function mt(t, F, S) {
      ...
      if (_ == u)
        return m;
      var d = E.indexOf(s) != -1 ? E.lastIndexOf(s) - 1 : E.length - 2;
      return [g, Y].indexOf(E[d]) != -1 && E.slice(d + 1, -1).every(function(V) {
        return V == s;
      }) && M == b || _ == N && [J, Y].indexOf(M) != -1 ? m : F.indexOf(a) != -1 ? y : _ == a && M == a ? m : I;
    }
    ...
    function Ct(t) {
      ...
      129489 <= t && t <= 129501 ? g : 127995 <= t && t <= 127999 ? b : t == 8205 ? N : t == 9792 || // So       FEMALE SIGN
      t == 9794 || // So       MALE SIGN
...
function Ex(r, n) {
  ...
  return {
    ...
    candidateEntity: i,
    addEntityWithDialog: (u, g, b, N) => {
      console.log("addEntity", g, b, N), i.value = {
        id: qt(),
        startOffset: g,
        endOffset: b,
        label: 1,
        text: N.substring(g, b)
      }, x.openAddingDialog();
    },
    updateEntityWithDialog: (u, g) => {
      console.log("updateEntity", g);
      const b = r.value.find((N) => N.id == g);
      b && (i.value = {
        id: b.id,
...
const px = ["id"], yx = {
  ...
  setup(r, { expose: n, emit: x }) {
    ...
    const s = x, a = qt(), e = P(null), D = P({}), C = P(-1), f = P(0), v = P(0), w = P(0), O = P(null), u = P(null), g = P(null), b = P([...i.entitiesData]), N = P(i.text), J = P(!1), {
      entities: Y,
      candidateEntity: m,
      addEntityWithDialog: I,
      updateEntityWithDialog: y,
      deleteEntityWithDialog: j,
      updateEntityAddPrefix: o,
    ...
    const _ = k(() => !it.value || it.value.length === 0 ? [] : it.value.map((B, L) => {
      const H = `${B.startOffset}:${B.endOffset}`, G = D.value[H] || 64;
      return {
        id: H,
        textLine: B,
        size: G
      ...
      return console.log("Entity array to process:", B), i.graphemeMode ? At.valueOf(B, d.value) : At.valueOf(B);
        ...
        }), [];
      {
        ...
        return new gx(L, e.value).split(d.value);
      }
    }), d = k(() => new Dx(i.text)), V = k(() => {
      if (g.value) {
    ...
    function _t() {
      lt(
        L0(() => {
          ...
          if (B) {
            const L = B.clientWidth, H = B.getBoundingClientRect();
            console.log(
              `Container found: clientWidth = ${L}, rect =`,
              H
            ), C.value = L, v.value = H.left, w.value = H.right - H.left, f.value = i.rtl ? w.value : 0;
          } else
    ...
    function Kt(B, L) {
      y(B, L.id), s("click:entity", B, L.id, i.record);
    }
    function Jt(B, L) {
    ...
    return (B, L) => {
      ...
      return R(), X(rt, null, [
        ...
        p("div", {
            ...
            default: A(({ item: G, index: dt }) => [
              ...
              (R(), xt(nx, {
                ...
                entities: M.value.filterByRange(
                  G.textLine.startOffset,
                  G.textLine.endOffset
                ),
                ...
                "onContextmenu:relation": L[0] || (L[0] = (st) => B.$emit("contextmenu:relation", st)),
                "onUpdate:height": ot,
                onSetSelectedEntity: L[1] || (L[1] = (st) => u.value = st),
                onSetSelectedRelation: L[2] || (L[2] = (st) => O.value = st)
          ...
          T(m) && (T(F) || T(S) || T(E)) ? (R(), xt(Gt, {
            key: 0,
            "candidate-entity": T(m),
            "entity-labels": B.entityLabels,
            "dialog4-adding": T(F),
            "dialog4-updating": T(S),
            "dialog4-deleting": T(E),
            onCancel: T(t),
            onConfirm: T(Ct),
            onUpdateEntityAddPrefix: T(o),
            onUpdateEntitySubtractPrefix: T(nt),
            onUpdateEntityAddSuffix: T(ut),
            onUpdateEntitySubtractSuffix: T(mt),
            onUpdateCandidateEntityLabel: L[3] || (L[3] = (G) => T(m).label = G)
