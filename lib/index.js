...
var x0 = (r, n, x) => n in r ? t0(r, n, { enumerable: !0, configurable: !0, writable: !0, value: x }) : r[n] = x;
var q = (r, n, x) => x0(r, typeof n != "symbol" ? n + "" : n, x);
import { defineComponent as Ft, computed as k, createElementBlock as X, openBlock as M, withModifiers as n0, createElementVNode as w, toDisplayString as d, createBlock as nt, createCommentVNode as Nt, Fragment as et, renderList as Dt, ref as T, watch as tt, nextTick as xt, onMounted as jt, createVNode as g, resolveComponent as Z, withCtx as F, createTextVNode as I, normalizeStyle as St, unref as N } from "vue";
var i0 = typeof global == "object" && global && global.Object === Object && global, r0 = typeof self == "object" && self && self.Object === Object && self, zt = i0 || r0 || Function("return this")(), At = zt.Symbol, Ut = Object.prototype, l0 = Ut.hasOwnProperty, a0 = Ut.toString, st = At ? At.toStringTag : void 0;
function s0(r) {
  var n = l0.call(r, st), x = r[st];
  try {
    r[st] = void 0;
    var i = !0;
  } catch {
...
var e0 = Object.prototype, u0 = e0.toString;
function C0(r) {
  return u0.call(r);
}
var f0 = "[object Null]", B0 = "[object Undefined]", $t = At ? At.toStringTag : void 0;
function h0(r) {
  return r == null ? r === void 0 ? B0 : f0 : $t && $t in Object(r) ? s0(r) : C0(r);
}
function D0(r) {
  return r != null && typeof r == "object";
}
var A0 = "[object Symbol]";
function g0(r) {
  return typeof r == "symbol" || D0(r) && h0(r) == A0;
}
var m0 = /\s/;
function F0(r) {
  for (var n = r.length; n-- && m0.test(r.charAt(n)); )
    ;
  return n;
}
var p0 = /^\s+/;
function v0(r) {
  return r && r.slice(0, F0(r) + 1).replace(p0, "");
}
function wt(r) {
  var n = typeof r;
  return r != null && (n == "object" || n == "function");
}
var Wt = NaN, E0 = /^[-+]0x[0-9a-f]+$/i, y0 = /^0b[01]+$/i, w0 = /^0o[0-7]+$/i, b0 = parseInt;
function Mt(r) {
  if (typeof r == "number")
    return r;
  if (g0(r))
  ...
  r = v0(r);
  var x = y0.test(r);
  return x || w0.test(r) ? b0(r.slice(2), x ? 2 : 8) : E0.test(r) ? Wt : +r;
}
var vt = function() {
  return zt.Date.now();
}, _0 = "Expected a function", O0 = Math.max, L0 = Math.min;
function k0(r, n, x) {
  var i, l, a, s, e, B, f = 0, C = !1, h = !1, A = !0;
  if (typeof r != "function")
    throw new TypeError(_0);
  n = Mt(n) || 0, wt(x) && (C = !!x.leading, h = "maxWait" in x, a = h ? O0(Mt(x.maxWait) || 0, n) : a, A = "trailing" in x ? !!x.trailing : A);
  function _(y) {
    var j = i, Q = l;
    return i = l = void 0, f = y, s = r.apply(Q, j), s;
  }
  function u(y) {
    return f = y, e = setTimeout(P, n), C ? _(y) : s;
  }
  function m(y) {
    var j = y - B, Q = y - f, it = n - j;
    return h ? L0(it, a - Q) : it;
  }
  function b(y) {
    var j = y - B, Q = y - f;
    return B === void 0 || j >= n || j < 0 || h && Q >= a;
  }
  function P() {
    var y = vt();
    if (b(y))
  ...
  function J(y) {
    return e = void 0, A && i ? _(y) : (i = l = void 0, s);
  }
  function Y() {
    e !== void 0 && clearTimeout(e), f = 0, i = B = l = e = void 0;
  }
  function p() {
    return e === void 0 ? s : J(vt());
  }
  function R() {
    var y = vt(), j = b(y);
    if (i = arguments, l = this, B = y, j) {
      if (e === void 0)
        return u(B);
      if (h)
        return clearTimeout(e), e = setTimeout(P, n), _(B);
    }
    return e === void 0 && (e = setTimeout(P, n)), s;
  }
  return R.cancel = Y, R.flush = p, R;
}
const U = [];
for (let r = 0; r < 256; ++r)
  U.push((r + 256).toString(16).slice(1));
function S0(r, n = 0) {
  return (U[r[n + 0]] + U[r[n + 1]] + U[r[n + 2]] + U[r[n + 3]] + "-" + U[r[n + 4]] + U[r[n + 5]] + "-" + U[r[n + 6]] + U[r[n + 7]] + "-" + U[r[n + 8]] + U[r[n + 9]] + "-" + U[r[n + 10]] + U[r[n + 11]] + U[r[n + 12]] + U[r[n + 13]] + U[r[n + 14]] + U[r[n + 15]]).toLowerCase();
}
let Et;
...
function qt(r, n, x) {
  let i;
  {
    const l = Date.now(), a = W0();
    M0(yt, l, a), i = R0(a, yt.msecs, yt.seq, n, x);
  }
  return S0(i);
}
function M0(r, n, x) {
...
const I0 = ["r", "fill", "cx", "cy"], T0 = ["x", "y", "dx", "textContent"], P0 = /* @__PURE__ */ Ft({
  ...
  setup(r, { emit: n }) {
    ...
    return (l, a) => (M(), X("g", {
      ...
      onClick: a[0] || (a[0] = (s) => l.$emit("click:entity", s)),
      onContextmenu: a[1] || (a[1] = n0((s) => l.$emit("contextmenu:entity"), ["prevent"]))
    }, [
      w("circle", {
        r: r.r,
        fill: r.color,
...
}), N0 = ["x1", "y1", "x2", "y2", "stroke", "stroke-width"], j0 = /* @__PURE__ */ Ft({
   ...
   */
  clone() {
    return new bt(this.low, this.high);
  }
  /**
...
class c {
  constructor(n = void 0, x = void 0, i = null, l = null, a = null, s = $) {
    if (this.left = i, this.right = l, this.parent = a, this.color = s, this.item = { key: n, value: x }, n && n instanceof Array && n.length === 2 && !Number.isNaN(n[0]) && !Number.isNaN(n[1])) {
      let [e, B] = n;
      e > B && ([e, B] = [B, e]), this.item.key = new z0(e, B);
    }
...
class ut {
  ...
  insert(n, x = n) {
    if (n === void 0) return;
    let i = new c(n, x, this.nil_node, this.nil_node, null, z);
  ...
  search(n, x = (i, l) => i === l ? l.output() : i) {
    let i = new c(n), l = [];
    return this.tree_search_interval(this.root, i, l), l.map((a) => x(a.item.value, a.item.key));
  }
  /**
  ...
  *iterate(n, x = (i, l) => i === l ? l.output() : i) {
  ...
  insert_fixup(n) {
    let x, i;
    for (x = n; x !== this.root && x.parent.color === z; )
      x.parent === x.parent.parent.left ? (i = x.parent.parent.right, i.color === z ? (x.parent.color = $, i.color = $, x.parent.parent.color = z, x = x.parent.parent) : (x === x.parent.right && (x = x.parent, this.rotate_left(x)), x.parent.color = $, x.parent.parent.color = z, this.rotate_right(x.parent.parent))) : (i = x.parent.parent.left, i.color === z ? (x.parent.color = $, i.color = $, x.parent.parent.color = z, x = x.parent.parent) : (x === x.parent.left && (x = x.parent, this.rotate_right(x)), x.parent.color = $, x.parent.parent.color = z, this.rotate_left(x.parent.parent)));
    this.root.color = $;
  }
  tree_delete(n) {
    let x, i;
  ...
  delete_fixup(n) {
    ...
    for (; x !== this.root && x.parent != null && x.color === $; )
      x === x.parent.left ? (i = x.parent.right, i.color === z && (i.color = $, x.parent.color = z, this.rotate_left(x.parent), i = x.parent.right), i.left.color === $ && i.right.color === $ ? (i.color = z, x = x.parent) : (i.right.color === $ && (i.color = z, i.left.color = $, this.rotate_right(i), i = x.parent.right), i.color = x.parent.color, x.parent.color = $, i.right.color = $, this.rotate_left(x.parent), x = this.root)) : (i = x.parent.left, i.color === z && (i.color = $, x.parent.color = z, this.rotate_right(x.parent), i = x.parent.left), i.left.color === $ && i.right.color === $ ? (i.color = z, x = x.parent) : (i.left.color === $ && (i.color = z, i.right.color = $, this.rotate_left(i), i = x.parent.left), i.color = x.parent.color, x.parent.color = $, i.left.color = $, this.rotate_right(x.parent), x = this.root));
    x.color = $;
  }
  tree_search(n, x) {
  ...
  testRedBlackProperty() {
    ...
    return this.tree_walk(this.root, function(x) {
      x.color === z && (x.left.color === $ && x.right.color === $ || (n = !1));
    }), n;
  }
...
class Vt {
  constructor() {
    q(this, "intervalPerLevel", []);
    q(this, "id2level", /* @__PURE__ */ new Map());
  }
  // <id, level>
  update(n, x) {
    for (const [l, a] of this.intervalPerLevel.entries())
      if (x.every((s) => !this.intersectAny(a, s))) {
        x.forEach((s) => {
          a.insert(s);
...
class G0 {
  ...
  render(n, x, i) {
    ...
    for (const a of x) {
      const s = this.createRanges(n, a), e = a.startsAfter(this.textLine.startOffset), B = i.getWidth(a.label), f = s.getIntervals(e, B);
      this.levelManager.update(a, f);
      const C = this.levelManager.fetchLevel(a);
      l.push(new U0(a, s, C));
    }
    return l;
  }
  createRanges(n, x) {
    const i = new V0(this.rtl), l = n.firstChild, a = Math.max(x.startOffset, this.textLine.startOffset) - this.textLine.startOffset, s = Math.min(x.endOffset, this.textLine.endOffset) - this.textLine.startOffset;
    if (l.textContent && l.textContent.length < s)
      return i.add(0, 0), i;
    const e = document.createRange();
    e.setStart(l, a), e.setEnd(l, s);
    const B = e.getClientRects();
    for (const f of B)
      i.add(f.left, f.right);
    return i;
  }
}
const K = Object.freeze({
  ...
  setup(r, { emit: n }) {
    const x = r, i = k(() => x.rtl ? -K.labelMargin : K.labelMargin), l = k(() => K.radius), a = k(() => x.selected ? K.lineWidth * 1.5 : K.lineWidth), s = k(() => x.rtl ? C(x.ranges.first.x2) : C(x.ranges.first.x1)), e = k(() => K.lineWidth + (K.lineWidth + x.fontSize + 8) * x.level + x.fontSize / 2 + 5), B = k(() => K.lineWidth + (K.lineWidth + x.fontSize + 8) * x.level), f = k(() => x.ranges.items.map((h) => [C(h.x1), C(h.x2)]));
    function C(h) {
      return h - x.margin;
    }
    return (h, A) => (M(), X("g", {
      onMouseover: A[2] || (A[2] = (_) => h.$emit("mouseover")),
      onMouseleave: A[3] || (A[3] = (_) => h.$emit("mouseleave"))
    }, [
      (M(!0), X(et, null, Dt(f.value, ([_, u], m) => (M(), nt(j0, {
        key: m,
        x1: _,
        x2: u,
        y: B.value,
      ...
      r.noText ? Nt("", !0) : (M(), nt(P0, {
        ...
        text: r.label,
        color: r.color,
        "onClick:entity": A[0] || (A[0] = (_) => h.$emit("click:entity", _)),
        "onContextmenu:entity": A[1] || (A[1] = (_) => h.$emit("contextmenu:entity"))
  ...
  setup(r) {
    ...
    return tt(
      ...
      ref_key: "textElement",
      ref: x
    }, null, 8, X0)) : (M(), X("text", Y0, "⮐"));
  }
}, K0 = /* @__PURE__ */ _t(Z0, [["__scopeId", "data-v-72684c03"]]);
class J0 {
  constructor(n, x, i, l) {
...
class Q0 {
  constructor(n, x) {
    q(this, "tree", new ut());
    for (const i of n) {
      const l = x.findById(i.fromId), a = x.findById(i.toId), s = new J0(
        i.id,
        i.labelId,
        l,
        a
      );
      this.tree.insert([s.startOffset, s.endOffset], s);
    }
  }
  /**
...
async function o0(r = {}) {
  const { timeout: n = 5e3 } = r;
  if (!(typeof document > "u" || !document.fonts))
    try {
      await Promise.race([
        document.fonts.ready,
        new Promise((x) => setTimeout(x, n))
      ]);
    } catch (x) {
      console.warn("Font loading detection failed:", x);
    }
}
async function $x(r, n = {}) {
  const { timeout: x = 5e3, retryCount: i = 3, retryDelay: l = 100 } = n;
  if (typeof document > "u" || !document.fonts)
    return;
  const a = r.map(async (s) => {
    let e = 0;
    for (; e < i; )
      try {
        const B = new FontFace(s, "url()");
        await Promise.race([
          B.loaded,
        ...
        if (e++, e >= i) {
          console.warn(`Failed to load font ${s} after ${i} attempts`);
          return;
        }
        await new Promise((f) => setTimeout(f, l));
      }
  });
  await Promise.all(a);
}
function Wx(r) {
  ...
  try {
    ...
    return console.warn(`Error checking font ${r}:`, n), !1;
  }
}
function Mx(r, n = "normal") {
  if (typeof document > "u")
    return;
  const x = document.createElement("link");
  x.rel = "preload", x.as = "font", x.type = "font/woff2", x.crossOrigin = "anonymous", x.href = "data:font/woff2;base64,", document.head.appendChild(x);
}
function Rx(r, n = "swap") {
  if (typeof document > "u")
    return;
...
function ht(r, n = 16) {
  return /[\u3000-\u9fff\uac00-\ud7af]/.test(r) ? n * 1 : n * 0.6;
}
async function d0(r, n, x = {}) {
  const { retryCount: i = 3, retryDelay: l = 100 } = x;
  typeof document < "u" && document.fonts && !document.fonts.check("16px serif") && await o0(x);
  const a = new Set(r), s = /* @__PURE__ */ new Map();
  a.delete(`
`);
  ...
  for (; B < i && !f; )
    try {
      if (n.getNumberOfChars() > 0) {
        for (let C = 0; C < n.getNumberOfChars(); C++) {
          const h = n.textContent.charAt(C), A = n.getExtentOfChar(C).width;
          if (A > 0.1)
            s.set(h, A);
          else
      ...
      if (B++, console.warn(`Font measurement attempt ${B} failed:`, C), B >= i) {
        console.warn("Font measurement failed after retries, using fallback");
        const h = parseFloat(window.getComputedStyle(n).fontSize) || 16;
        for (const A of e)
          s.set(A, ht(A, h));
        break;
      }
...
class lt {
  constructor(n, x, i, l, a) {
    this.fontSize = n, this.fontFamily = x, this.fontWeight = i, this.lineHeight = l, this.width = a;
  }
  widthOf(n, x = !1) {
    return x ? Math.max(
  ...
  static async create(n, x) {
    try {
      const i = await d0(n, x), l = parseFloat(window.getComputedStyle(x).fontSize), a = window.getComputedStyle(x).fontFamily, s = window.getComputedStyle(x).fontWeight, e = x.getBoundingClientRect().height;
      return new lt(l, a, s, e, i);
    } catch (i) {
      return console.warn("Font creation failed, using synchronous fallback:", i), lt.createSync(n, x);
    }
  }
  static createSync(n, x) {
    const i = new Set(n), l = /* @__PURE__ */ new Map();
    i.delete(`
`);
    const a = Array.from(i);
    a.sort(), x.textContent = a.join("");
    try {
      for (let C = 0; C < x.getNumberOfChars(); C++) {
        const h = x.textContent.charAt(C), A = x.getExtentOfChar(C).width;
        if (A > 0.5)
          l.set(h, A);
        else {
          const _ = parseFloat(window.getComputedStyle(x).fontSize) || 16;
          l.set(h, ht(h, _)), console.warn(`Using fallback width for character '${h}': ${A} -> ${ht(h, _)}`);
        }
      }
    } catch (C) {
      console.warn("Synchronous font measurement failed, using fallback widths:", C);
    ...
    l.set(`
`, 0);
    const s = parseFloat(window.getComputedStyle(x).fontSize), e = window.getComputedStyle(x).fontFamily, B = window.getComputedStyle(x).fontWeight, f = x.getBoundingClientRect().height;
    return x.textContent = "", new lt(s, e, B, f, l);
  }
}
class Gt {
  constructor(n, x, i, l, a = K.maxLabelLength) {
    this.id = n, this.text = x, this.color = i, this.textWidth = l, this.maxLength = a;
  }
  get width() {
...
class xx {
  constructor(n, x, i, l, a) {
    q(this, "levelManager", new Vt());
    this.relations = n, this.relationLabels = x, this.textLine = i, this.left = l, this.right = a;
  }
  render(n, x) {
    const i = [];
    this.levelManager.clear();
    ...
    n.forEach((a) => {
      l.set(a.entity.id, a);
    }), this.relations.sort((a, s) => a.width - s.width);
    for (const a of this.relations) {
      if (!a.isVisible(this.textLine.startOffset))
        continue;
      let s = this.left, e = this.right, B = "";
      const f = l.get(a.fromEntity.id), C = l.get(a.toEntity.id), h = this.relationLabels.getById(a.labelId);
      let A = a.isOpenOnLeft(this.textLine.startOffset), _ = a.isOpenOnRight(this.textLine.endOffset);
      if (A && _ ? (s = this.left, e = this.right) : A ? x ? f ? s = f.center : C && (s = C.center) : f ? e = f.center : C && (e = C.center) : _ ? x ? f ? e = f.center : C && (e = C.center) : f ? s = f.center : C && (s = C.center) : C && f && (s = Math.min(C.center, f.center), e = Math.max(C.center, f.center)), C && s === C.center ? B = "start" : C && e === C.center && (B = "end"), s > e && ([s, e] = [e, s]), x && ([A, _] = [_, A]), e - s < h.truncatedWidth) {
        const m = s + (e - s) / 2, b = h.truncatedWidth / 2;
        this.levelManager.update(a, [[m - b, m + b]]);
      } else
        this.levelManager.update(a, [[s, e]]);
      const u = this.levelManager.fetchLevel(a);
      i.push({
        x1: s,
        x2: e,
        level: u,
...
const nx = ["direction", "id", "height"], ix = ["transform"], rx = {
  __name: "Vline",
  props: {
  ...
  setup(r, { emit: n }) {
    ...
    const a = T("500px"), s = k(() => `translate(0, ${x.font.lineHeight})`), e = k(() => l.value ? new G0(x.textLine, x.rtl).render(l.value, x.entities, x.entityLabels) : []), B = k(() => new xx(x.relations, x.relationLabels, x.textLine, x.left, x.right).render(e.value, x.rtl));
    k(() => Math.max(...B.value.map((p) => p.level), 0));
    const f = k(() => {
      const p = Math.max(...B.value.map((R) => R.level));
      return p < 0 ? 0 : 20 + x.font.fontSize * (p + 1.5);
    });
    k(() => `translate(0, ${f.value})`);
    const C = k(() => x.rtl ? "rtl" : "ltr"), h = k(() => `${x.textLine.startOffset}:${x.textLine.endOffset}`), A = k(() => `basetext-${x.annotatorUuid}-${h.value}`), _ = k(() => `svg-${x.annotatorUuid}-${h.value}`);
    function u() {
      xt(() => {
    ...
    function m() {
      const p = document.getElementById(_.value);
      if (p) {
        const R = p.getBBox().height + 30;
        p.style.height = `${R}px`, i("update:height", h.value, R);
      }
    }
    function b(p) {
      return p.startOffset < x.textLine.startOffset;
    }
    function P(p) {
      return x.entityLabels.getColor(p.label);
    }
    function J(p) {
      return x.entityLabels.getText(p.label);
    }
    function Y(p) {
      return x.selectedRelation ? x.selectedRelation.consistOf(p) : x.selectedEntities.some((R) => R.id === p.id);
    }
    return (p, R) => (M(), X("svg", {
      version: "1.1",
      ...
      w("g", { transform: s.value }, [
        ...
        (M(!0), X(et, null, Dt(e.value, (y) => (M(), nt(H0, {
          key: y.entity.id,
          ranges: y.ranges,
          color: P(y.entity),
          label: J(y.entity),
          ...
          selected: Y(y.entity),
          "onClick:entity": (j) => p.$emit("click:entity", j, y.entity),
          "onContextmenu:entity": (j) => p.$emit("contextmenu:entity", y.entity),
          onMouseover: (j) => p.$emit("setSelectedEntity", y.entity),
          onMouseleave: R[0] || (R[0] = (j) => p.$emit("setSelectedEntity", null))
...
}, lx = /* @__PURE__ */ _t(rx, [["__scopeId", "data-v-7b0dff92"]]), ax = { class: "ma-3" }, sx = { class: "text-h5 text-indigo ml-5" }, ex = { class: "ma-3" }, ux = { class: "text-h5 text-indigo ml-5" }, Cx = { class: "d-flex justify-space-around my-3" }, fx = { class: "ma-3" }, Bx = { class: "text-h5 text-indigo ml-5" }, hx = /* @__PURE__ */ Ft({
  ...
  setup(r) {
    return (n, x) => {
      const i = Z("v-card-title"), l = Z("v-btn"), a = Z("v-card-subtitle"), s = Z("v-card"), e = Z("v-radio"), B = Z("v-radio-group"), f = Z("v-card-text"), C = Z("v-spacer"), h = Z("v-card-actions"), A = Z("v-dialog"), _ = Z("v-icon");
      return M(), X(et, null, [
        g(A, {
          ...
          default: F(() => [
            g(s, { class: "ma-3" }, {
              default: F(() => [
                ...
                g(f, null, {
                  default: F(() => [
                    g(s, { variant: "outlined" }, {
                      default: F(() => [
                        w("div", ax, [
                          x[16] || (x[16] = w("span", null, [
                            w("small", null, "選択したテキスト:")
                          ], -1)),
                          w("span", sx, [
                            w("b", null, d(n.candidateEntity.text), 1)
                          ])
                        ])
                      ]),
                      _: 1
                    ...
                    g(B, {
                      ...
                      default: F(() => [
                        (M(!0), X(et, null, Dt(n.entityLabels, (u) => (M(), nt(e, {
                          key: u.id,
                          label: `${u.id}: ${u.text}`,
                          value: u.id,
                  ...
                  default: F(() => [
                    g(s, { variant: "outlined" }, {
                      default: F(() => [
                        ...
                        x[30] || (x[30] = w("hr", { class: "mx-10" }, null, -1)),
                        w("div", Cx, [
                          g(C),
                          w("div", null, [
                            g(l, {
                          ...
                          x[28] || (x[28] = w("div", { class: "mx-2 mt-1" }, "前", -1)),
                          w("div", null, [
                            g(l, {
                          ...
                          x[29] || (x[29] = w("div", { class: "mx-2 mt-1" }, "後", -1)),
                          w("div", null, [
                            g(l, {
...
}), Ht = /* @__PURE__ */ _t(hx, [["__scopeId", "data-v-cc04ca7c"]]);
function Dx(r) {
...
(function(r) {
  function n() {
    var x = 0, i = 1, l = 2, a = 3, s = 4, e = 5, B = 6, f = 7, C = 8, h = 9, A = 10, _ = 11, u = 12, m = 13, b = 14, P = 15, J = 16, Y = 17, p = 0, R = 1, y = 2, j = 3, Q = 4;
    function it(t, v) {
      return 55296 <= t.charCodeAt(v) && t.charCodeAt(v) <= 56319 && 56320 <= t.charCodeAt(v + 1) && t.charCodeAt(v + 1) <= 57343;
    }
    function Ct(t, v) {
      v === void 0 && (v = 0);
      var S = t.charCodeAt(v);
      if (55296 <= S && S <= 56319 && v < t.length - 1) {
        var E = S, O = t.charCodeAt(v + 1);
        return 56320 <= O && O <= 57343 ? (E - 55296) * 1024 + (O - 56320) + 65536 : E;
      }
      if (56320 <= S && S <= 57343 && v >= 1) {
        var E = t.charCodeAt(v - 1), O = S;
        return 55296 <= E && E <= 56319 ? (E - 55296) * 1024 + (O - 56320) + 65536 : O;
      }
      return S;
    }
    function pt(t, v, S) {
      var E = [t].concat(v).concat([S]), O = E[E.length - 2], W = S, Bt = E.lastIndexOf(b);
      if (Bt > 1 && E.slice(1, Bt).every(function(V) {
        return V == a;
      }) && [a, m, Y].indexOf(t) == -1)
        return y;
      var rt = E.lastIndexOf(s);
      if (rt > 0 && E.slice(1, rt).every(function(V) {
        return V == s;
      }) && [u, s].indexOf(O) == -1)
      ...
      if (O == x && W == i)
        return p;
      if (O == l || O == x || O == i)
        return W == b && v.every(function(V) {
          return V == a;
        }) ? y : R;
      if (W == l || W == x || W == i)
        return R;
      if (O == B && (W == B || W == f || W == h || W == A))
        return p;
      if ((O == h || O == f) && (W == f || W == C))
        return p;
      if ((O == A || O == C) && W == C)
      ...
      if (O == u)
        return p;
      var o = E.indexOf(a) != -1 ? E.lastIndexOf(a) - 1 : E.length - 2;
      return [m, Y].indexOf(E[o]) != -1 && E.slice(o + 1, -1).every(function(V) {
        return V == a;
      }) && W == b || O == P && [J, Y].indexOf(W) != -1 ? p : v.indexOf(s) != -1 ? y : O == s && W == s ? p : R;
    }
    this.nextBreak = function(t, v) {
      if (v === void 0 && (v = 0), v < 0)
        return 0;
      if (v >= t.length - 1)
        return t.length;
      for (var S = ft(Ct(t, v)), E = [], O = v + 1; O < t.length; O++)
        if (!it(t, O - 1)) {
          var W = ft(Ct(t, O));
          if (pt(S, E, W))
            return O;
      ...
      for (var v = [], S = 0, E; (E = this.nextBreak(t, S)) < t.length; )
        v.push(t.slice(S, E)), S = E;
      return S < t.length && v.push(t.slice(S)), v;
    }, this.iterateGraphemes = function(t) {
      var v = 0, S = {
        next: (function() {
          var E, O;
          return (O = this.nextBreak(t, v)) < t.length ? (E = t.slice(v, O), v = O, { value: E, done: !1 }) : v < t.length ? (E = t.slice(v), v = t.length, { value: E, done: !1 }) : { value: void 0, done: !0 };
        }).bind(this)
      };
      ...
      for (var v = 0, S = 0, E; (E = this.nextBreak(t, S)) < t.length; )
        S = E, v++;
      return S < t.length && v++, v;
    };
    function ft(t) {
      ...
      917760 <= t && t <= 917999 ? a : 127462 <= t && t <= 127487 ? s : t == 2307 || // Mc       DEVANAGARI SIGN VISARGA
      ...
      43360 <= t && t <= 43388 ? B : 4448 <= t && t <= 4519 || // Lo  [72] HANGUL JUNGSEONG FILLER..HANGUL JUNGSEONG O-YAE
      55216 <= t && t <= 55238 ? f : 4520 <= t && t <= 4607 || // Lo  [88] HANGUL JONGSEONG KIYEOK..HANGUL JONGSEONG SSANGNIEUN
      ...
      129489 <= t && t <= 129501 ? m : 127995 <= t && t <= 127999 ? b : t == 8205 ? P : t == 9792 || // So       FEMALE SIGN
      t == 9794 || // So       MALE SIGN
      ...
      t == 128640 || // So       ROCKET
      t == 128658 ? J : 128102 <= t && t <= 128105 ? Y : _;
    }
    return this;
  }
...
var Ax = Xt.exports;
const gx = /* @__PURE__ */ Dx(Ax);
class mx {
  constructor(n) {
    q(this, "graphemes", []);
    q(this, "g2c", /* @__PURE__ */ new Map());
    q(this, "c2g", /* @__PURE__ */ new Map());
    q(this, "idx2len", /* @__PURE__ */ new Map());
...
class Yt {
  constructor(n, x, i, l, a) {
    q(this, "text");
    if (this.id = n, this.label = x, this.startOffset = i, this.endOffset = l, this.text = a, i > l)
...
class mt {
  constructor(n) {
    q(this, "tree", new ut());
    q(this, "id2entity", /* @__PURE__ */ new Map());
    for (const x of n)
...
class px {
  ...
  split(n) {
    ...
    let x = 0, i = x;
    const l = [];
    for (let a = 0; a < n.graphemeLength; a++) {
      const s = n.graphemeAt(a);
      this.needsNewline(i, n, s) ? (l.push(new Rt(x, i)), this.widthManager.reset(), Fx(n.substr(i, 2)) ? x = i + 2 : Tt(s) || Pt(s) ? x = i + 1 : (x = i, this.widthManager.add(this.font.widthOf(s, s.length > 1)))) : this.widthManager.add(this.font.widthOf(s, s.length > 1)), i += s.length;
    }
    return this.widthManager.isEmpty() || l.push(new Rt(x, n.codePointLength)), l;
  }
  needsNewline(n, x, i) {
    const l = x.charAt(n);
    if (Tt(l) || Pt(l) || !this.widthManager.canAdd(this.font.widthOf(i, i.length > 1)))
      return !0;
    const a = this.calculateWordLength(n, x);
    return !!(a <= this.widthManager.maxWidth && this.widthManager.isFull(a));
  }
  calculateWordLength(n, x) {
    const i = x.getWord(n);
    if (i) {
      let l = 0;
      for (let a = n; a < n + i.length; a++) {
        const s = x.graphemeAt(a);
        l += s ? this.font.widthOf(s, s.length > 1) : 0;
      }
      return l;
    } else
      return 0;
...
class Ex {
  ...
  getRange() {
    ...
    if (!n || n.rangeCount === 0)
      return [0, 0];
    const x = (B = n.anchorNode) == null ? void 0 : B.parentNode, i = (f = n.focusNode) == null ? void 0 : f.parentNode;
    if (!x || !i)
      return [0, 0];
    const l = x.annotatorElement, a = i.annotatorElement;
    if (!l || !a)
      return [0, 0];
    const s = l.startOffset + n.anchorOffset, e = a.startOffset + n.focusOffset;
    return n.removeAllRanges(), s > e ? [e, s] : [s, e];
  }
  validate(n, x, i) {
...
function wx(r, n) {
  ...
  return {
    ...
    candidateEntity: i,
    addEntityWithDialog: (u, m, b, P) => {
      console.log("addEntity", m, b, P), i.value = {
        id: qt(),
        startOffset: m,
        endOffset: b,
        label: 1,
        text: P.substring(m, b)
      }, x.openAddingDialog();
    },
    updateEntityWithDialog: (u, m) => {
      console.log("updateEntity", m);
      const b = r.value.find((P) => P.id == m);
      b && (i.value = {
        id: b.id,
    ...
    deleteEntityWithDialog: (u) => {
      ...
      const m = r.value.find((b) => b.id == u.id);
      m && (i.value = {
        id: m.id,
...
const bx = ["id"], _x = {
  ...
  setup(r, { expose: n, emit: x }) {
    ...
    const a = x, s = qt(), e = T(null), B = T({}), f = T(-1), C = T(0), h = T(0), A = T(0), _ = T(null), u = T(null), m = T(null), b = T([...i.entitiesData]), P = T(i.text), J = T(!1), {
      entities: Y,
      candidateEntity: p,
      addEntityWithDialog: R,
      updateEntityWithDialog: y,
      deleteEntityWithDialog: j,
      updateEntityAddPrefix: Q,
      updateEntitySubtractPrefix: it,
      updateEntityAddSuffix: Ct,
      updateEntitySubtractSuffix: pt,
      confirmAction: ft,
      cancelAction: t,
      dialog4Adding: v,
      dialog4Updating: S,
    ...
    tt(
      ...
      b,
      (D) => {
        J.value || a("update:entitiesData", [...D]);
      },
      { deep: !0 }
    ), jt(() => {
      const D = document.getElementById(`text-${s}`);
      m.value = D, window.addEventListener("resize", Ot), Ot(), console.log("Received text in VAnnotator:", i.text), console.log("Virtual scroll items:", O.value);
    }), tt(
      () => i.text,
      () => {
        B.value = {}, xt(() => {
          console.log("watch text nextTick ----------"), m.value && (e.value = lt.createSync(i.text, m.value)), console.log("Font x:", e.value, "*****************");
        });
      },
      { immediate: !0 }
    );
    const O = k(() => !rt.value || rt.value.length === 0 ? [] : rt.value.map((D, L) => {
      const G = `${D.startOffset}:${D.endOffset}`, H = B.value[G] || 64;
      return {
        id: G,
        textLine: D,
        size: H
      ...
      return console.log("Entity array to process:", D), i.graphemeMode ? mt.valueOf(D, o.value) : mt.valueOf(D);
    }), Bt = k(() => (Lt(), new Q0(i.relations, W.value))), rt = k(() => {
      if (console.log("Computing textLines..."), console.log("Font:", e.value), !e.value)
        return console.warn("Font is null, attempting to initialize."), xt(() => {
          m.value && (e.value = lt.createSync(i.text, m.value), console.log("Font initialized:", e.value));
        }), [];
      if (console.log("Entity Label List:", V.value), console.log("Max Width:", f.value), !e.value || !V.value || f.value === -1)
      ...
      {
        const D = V.value.maxLabelWidth, L = new vx(
          f.value + i.rightOffeset,
          D
        );
        return new px(L, e.value).split(o.value);
      }
    }), o = k(() => new mx(i.text)), V = k(() => {
      if (m.value) {
      ...
      return null;
    }), Kt = k(() => u.value ? i.selectedEntities.concat(u.value) : i.selectedEntities);
    function Ot() {
      xt(
        k0(() => {
          console.log(`Setting max width for container-${s}: ${f.value}`);
          const D = document.getElementById(`container-${s}`);
          if (D) {
            const L = D.clientWidth, G = D.getBoundingClientRect();
            console.log(
              `Container found: clientWidth = ${L}, rect =`,
              G
            ), f.value = L, h.value = G.left, A.value = G.right - G.left, C.value = i.rtl ? A.value : 0;
          } else
            console.log(`Container element for container-${s} not found`);
        }, 500)
      );
    }
    function Jt(D, L) {
      y(D, L.id), a("click:entity", D, L.id, i.record);
    }
    function Qt(D, L) {
      a("click:relation", D, L);
    }
    function ot(D) {
      j(D), a("contextmenu:entity", D, i.record);
    }
    function dt(D, L) {
      B.value[D] = L;
    }
    function Lt() {
      _.value = null, u.value = null;
    }
    function kt(D) {
      try {
        console.log("entityList:", W.value);
        const L = new Ex(
          i.allowOverlapping,
          i.graphemeMode
        ), [G, H] = L.getOffsets(
    ...
    return (D, L) => {
      ...
      return M(), X("div", {
        ...
        g(G, {
          ...
          default: F(({ item: H, index: ct }) => [
            (M(), nt(lx, {
              key: `${ct}:${D.rtl}`,
              "annotator-uuid": N(s),
              dark: D.dark,
              entities: W.value.filterByRange(
              ...
              relationLabels: Zt.value,
              font: e.value,
              rtl: D.rtl,
              "selected-entities": Kt.value,
              "selected-relation": _.value,
              text: D.text,
              textLine: H.textLine,
              "base-x": C.value,
              left: h.value,
              ...
              "onClick:entity": Jt,
              "onClick:relation": Qt,
              "onContextmenu:entity": ot,
              "onContextmenu:relation": L[0] || (L[0] = (at) => D.$emit("contextmenu:relation", at)),
              "onUpdate:height": dt,
              onSetSelectedEntity: L[1] || (L[1] = (at) => u.value = at),
              onSetSelectedRelation: L[2] || (L[2] = (at) => _.value = at)
        ...
        N(p) && (N(v) || N(S) || N(E)) ? (M(), nt(Ht, {
          key: 0,
          "candidate-entity": N(p),
          ...
          onUpdateEntitySubtractPrefix: N(it),
          onUpdateEntityAddSuffix: N(Ct),
          onUpdateEntitySubtractSuffix: N(pt),
          onUpdateCandidateEntityLabel: L[3] || (L[3] = (H) => N(p).label = H)
        }, null, 8, ["candidate-entity", "entity-labels", "dialog4-adding", "dialog4-updating", "dialog4-deleting", "onCancel", "onConfirm", "onUpdateEntityAddPrefix", "onUpdateEntitySubtractPrefix", "onUpdateEntityAddSuffix", "onUpdateEntitySubtractSuffix"])) : Nt("", !0)
      ], 40, bx);
    };
  }
}), Ix = {
  install(r, n) {
    r.component("VAnnotator", Lx), r.component("EntityDialogs", Ht);
  }
};
export {
  Ht as EntityDialogs,
  Lx as VAnnotator,
  Ix as VAnnotatorV3,
  Rx as addFontDisplay,
  Ix as default,
  ht as getFallbackCharWidth,
  Wx as isFontLoaded,
  d0 as measureTextWithFallback,
  Mx as preloadFont,
  o0 as waitForFonts,
  $x as waitForSpecificFonts
};
